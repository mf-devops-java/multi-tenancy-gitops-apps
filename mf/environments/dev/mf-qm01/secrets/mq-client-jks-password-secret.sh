...
# Set variables
KEY_STORE_PASSWORD=${KEY_STORE_PASSWORD:-mfclientdev}
...
kubeseal -n dev --controller-name=${SEALED_SECRET_CONTOLLER_NAME} --controller-namespace=${SEALED_SECRET_NAMESPACE} -o yaml < delete-mf-client-jks-password-secret.yaml > mf-client-jks-password-secret.yaml
